package Java.A10_01_PracticaGuiadaEjercicios.E08_ImprimirPrecioUnitario;
...
public class ejercicio08
{
    public static void main(String[] args)
    {
        ...
        catalogo.stream().forEach(Producto -> System.out.println(Funciones.toDecimalString(Producto.getPrecioUnitario())));
    }
}
